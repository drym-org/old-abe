...
class TestCalculateIncomingAttribution:
    ...
    def test_matrix(
        ...
        assert attribution.share == expected_attribution
...
class TestDiluteAttributions:
    ...
    def test_matrix(
        ...
        dilute_attributions(incoming_attribution, normalized_attributions)
        a_share = normalized_attributions[email]
        b_share = normalized_attributions['b@c.com']
        assert a_share == expected_attribution
        assert b_share == 1 - expected_attribution
